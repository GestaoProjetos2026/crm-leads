...
> 💡 **Nota de alteração:** Removi a linha `![7440c45b...](/docs/Banco_de_dados_v0.0.png)` que ficava aqui, pois era uma tag de imagem quebrada apontando para um diretório local.
